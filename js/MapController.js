...
var MapController = {
    ...
    doSAMSearchSpatial: function (geom) {
        ...
        //highlight buffer area
        var g = new esri.Graphic();
        g.geometry = geom;
        g.geometry.spatialReference = map.spatialReference;
        g.symbol = MapController.symBuildingHighlight;
        MapController.glBuildingHighlight.add(g);
